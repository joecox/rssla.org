...
<head>
   ...
   <script>
      ...
      window.onload = function ()
      {
         ...
         $("input[name=firstyears]").val(data[0]);
         $("input[name=secondyears]").val(data[1]);
         $("input[name=thirdyears]").val(data[2]);
         $("input[name=fourthyears]").val(data[3]);
...
*/
         ...
         $("#canvas").css("left", "49.5px");
         $(window).ready(function () {
            if (!disp && wsh >= (400 + csh - wh))
            {
...
<body>
   <div id="wrapper">
      ...
      <div class="main clearfix">
         ...
         <?php $selected="classpoints"; include($root."/eboard/eboard_sidenav.php"); ?>
         <div class="cont three-quarters">
            <div class="rowtitle"><span>Class Points Updater</span></div>
            <div class="wrap" style="height: 650px">
               <p id="headline" style="font-size: 1.4rem; text-align: center;">Current standings:</p>
               <form action="updateclasspoints.php" method="POST">
                  <span>
                        <input type="text" name="firstyears" size="7" style="margin-left: 112px;"/>
                        <input type="text" name="secondyears" size="7" style="margin-left: 60px;"/>
                        <input type="text" name="thirdyears" size="7" style="margin-left: 60px;"/>
                        <input type="text" name="fourthyears" size="7" style="margin-left: 60px;"/>
                  </span>
               <span class="button" onclick="$('form').submit()" style="margin-left: 20px;">Update</span>
               </form>
               <canvas class="h-align" id="canvas" width="550" height="500" style="z-index: 0; top: 100px;">[No canvas support, please update your browser.]</canvas>
               <img src="/resources/images/classpoints/hourglass.png" style="position:absolute; top: 94px; left: 50px; background-color:transparent">
            </div>
         </div>
      </div>
