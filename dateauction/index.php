      ...
      <div class="main clearfix">
         ...
         <div class="cont solo">
            <div class="profilenav">
               <span class="profilenavitem" meta="0">Home</span>
               <span class="profilenavitem" meta="1">Crystal Lin</span>
               <span class="profilenavitem" meta="2">Dylan Black</span>
               <span class="profilenavitem" meta="3">Jordan Beres</span>
               <span class="profilenavitem" meta="4">Dylan Redor</span>
               <span class="profilenavitem" meta="5">Julie Wang</span>
               <span class="profilenavitem" meta="6">Jon Han</span>
               <span class="profilenavitem" meta="7">Serena Lee</span>
               <span class="profilenavitem" meta="8">Angel Barajas</span>
            </div>
            <div class="profilewrap">
               <div style="position: absolute; left: 20px; height: 600px; width: 380px; background-color: white; z-index: 5"></div>
               <img src="/resources/images/dateauction/hosts.png">
               ...
               <div class="profileframe" id="frame1">
                  <div class="profile">
                     ...
                     <div class="highlight" style="padding: 0 5px">Which Hogwarts house do you belong in? Why?</div>
                     ...
                     <p>Piercing eyes and the Body of Adonis...</br>Or you know, someone who's sweet and kind and smart and good-looking and athletic and saves puppies and works for a non-profit and has money and loves kids.</p>
                  </div>
               </div>
               <div class="profileframe" id="frame2">
                  <div class="profile">
                     ...
                     <p>"I think Bigfoot IS blurry, that's the problem. It's not the photographer's fault. And that's extra scary to me, because there's a large, out-of-focus monster roaming the countryside." - Mitch Hedberg</p>
