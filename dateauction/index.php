   ...
   <div id="wrapper">
      ...
      <div class="main clearfix">
         ...
         <div class="cont">
               ...
               <span class="auctionee" meta="3"></span>
               <span class="auctionee" meta="4"></span>
               <br>
               <span class="auctionee" meta="5"></span>
               <span class="auctionee" meta="6"></span>
               <span class="auctionee" meta="7"></span>
               <span class="auctionee" meta="8"></span>
               <br>
               </div>
            <div class="profilewrapper">
               <div class="profileframe" id="currentframe">
                  <div class="home">
                     <h1>Welcome to RSS Date Auction!</h1>
                     <p class="intro"> 
                        The Date Auction is a fundraiser traditionally held at the 
                        first general meeting of spring quarter. At this exciting contest, 
                        you and your fellow students will bid for a date with one of 
                        our eight RSS auctionees (one girl and one boy from each class). 
